...
--personel tablosundaki sehir sutununun adini ulke olarak degistirin
...
--primary key-->bir sutunun null icermemesini ve sutundaki verilerin benzersiz olmaini saglar(not null-unique)
--foreign key-->baska bir tablodaki primary key i referans göstermek icin kullanilir
--boylelikle tablolar arasinda iliski kurmus oluruz.
--unique --> bir sutundaki tum degerlerin benzersi yani tek olmasini saglar
--Not null-->bir sutunun null icermemesini yani boz olmamasini saglar
--not null kısıtlaması icin constranint ismi taniımlanmaz. bu kısıtlama veri turunden hemen sonra yerlestirilir.
--check--> bir sutuna yerlestirilebilecek deger aralıgını sınırlamak icin kullanilir.

CREATE TABLE calisanlar
(
id CHAR(5) PRIMARY KEY, -- not null + unique
isim VARCHAR(50) UNIQUE, --unique --> bir sutundaki tum degerlerin benzersi yani tek olmasini saglar
maas int NOT NULL,--Not null-->bir sutunun null icermemesini yani boz olmamasini saglar
ise_baslama DATE
);
